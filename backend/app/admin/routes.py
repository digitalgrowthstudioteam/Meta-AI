...
async def list_users(
    ...
    for u in users:
        ...
        # 3. CRASH FIX: Removed the incorrect 'Campaign.user_id' query.
        # We will return 0 for now to keep the dashboard working.
        ...
        response.append(
            {
                ...
                "ai_campaigns_active": 0, # Hardcoded to 0 to stop crash
            }
        )
